...
REWARD_GOAL_STATE = 100
REWARD_DANGEROUS_STATE = 60

GRID_WORLD3_REWARDS = [
    [REWARD_DANGEROUS_STATE, REWARD_NORMAL_STATE,REWARD_NORMAL_STATE, REWARD_NORMAL_STATE, REWARD_GOAL_STATE]
...
GRID_WORLD4_REWARDS = [
    ...
    [REWARD_NORMAL_STATE,    0,                   REWARD_NORMAL_STATE, REWARD_NORMAL_STATE],
    [REWARD_DANGEROUS_STATE, REWARD_NORMAL_STATE, REWARD_NORMAL_STATE, REWARD_NORMAL_STATE],
...
# меняй тут
def find_policy_via_value_iteration(problem, discount_factor):
    epsilon = 0.0000000000000000001
    policy = mdp_agent.find_policy_via_value_iteration(problem, discount_factor, epsilon)
    return policy
    
# меняй тут    
def find_policy_via_policy_iteration(problem, discount_factor):
    policy = mdp_agent.find_policy_via_policy_iteration(problem, discount_factor)
    return policy
...
if __name__ == "__main__":
    ...
    policy1 = find_policy_via_value_iteration(env, 0.)
    #policy2 = init_policy(env)
